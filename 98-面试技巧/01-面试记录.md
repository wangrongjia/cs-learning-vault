...
### 面试问题记录
几种多线程的实现   [02-多线程 > 几种多线程的实现](../02-编程语言/01-JAVA/02-并发/02-并发.md#几种多线程的实现)
多线程间的同步方式 [02-linux线程间同步的方式](../96-计算机原理/01-操作系统/02-linux线程间同步的方式.md)
...
水平越权  纵向越权
数字签名  数字证书
linux常用的指令  [03-linux常用命令](../96-计算机原理/01-操作系统/03-linux常用命令.md) https://cloud.tencent.com/developer/article/1540697
对云 云计算有什么了解
未来规划
怎么提高技术
...
redis使用场景
lua脚本用过么
linux使用的多么  常用命令有哪些  [03-linux常用命令](../96-计算机原理/01-操作系统/03-linux常用命令.md) https://cloud.tencent.com/developer/article/1540697
...
动态配置线程池参数  [04-线程池ThreadPoolExecutor > 动态化设置线程池参数](../02-编程语言/01-JAVA/02-并发/04-线程池ThreadPoolExecutor.md#动态化设置线程池参数)
...
线程不安全的集合变成线程安全的  [07-线程-集合 > 线程不安全的集合变成线程安全的](../02-编程语言/01-JAVA/02-并发/07-线程-集合.md#线程不安全的集合变成线程安全的)
synchronized和juc包的区别  [06-synchronized > synchronized和juc包的区别](../02-编程语言/01-JAVA/02-并发/06-synchronized.md#synchronized和juc包的区别)
...
多线程的使用场景  [04-线程池ThreadPoolExecutor > 线程池的使用场景](../02-编程语言/01-JAVA/02-并发/04-线程池ThreadPoolExecutor.md#线程池的使用场景)
创建线程的方式 [02-多线程 > 几种多线程的实现](../02-编程语言/01-JAVA/02-并发/02-并发.md#几种多线程的实现)
runnable callable区别 [02-多线程 > runnable callable区别](../02-编程语言/01-JAVA/02-并发/02-并发.md#runnable%20callable区别)
线程池参数 运行原理 [04-线程池ThreadPoolExecutor](../02-编程语言/01-JAVA/02-并发/04-线程池ThreadPoolExecutor.md)
线程池 execute  submit区别 [04-线程池ThreadPoolExecutor > submit和execute区别](../02-编程语言/01-JAVA/02-并发/04-线程池ThreadPoolExecutor.md#submit和execute区别)
...
threadLocal的使用场景 [03-ThreadLocal](../02-编程语言/01-JAVA/02-并发/03-ThreadLocal.md)
...
优先队列  priorityQueue
java中线程安全相关的东西   
volatile  synchorized  [05-多线程jvm实现(volatile,synchronized)](../02-编程语言/01-JAVA/02-并发/05-多线程jvm实现(volatile,synchronized).md)  [06-synchronized](../02-编程语言/01-JAVA/02-并发/06-synchronized.md)
synchorized锁升级过程  [06-synchronized](../02-编程语言/01-JAVA/02-并发/06-synchronized.md)
